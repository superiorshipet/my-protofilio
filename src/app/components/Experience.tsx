...
const experiences = [
  ...
  },
  {
    ...
    description: "Designed and implemented RESTful APIs and microservices architecture for enterprise clients.",
    technologies: ["ASP.NET Core", "SQL Server", "Redis", "Kubernetes"],
    icon: Database,
  },
  {
    period: "2022 - 2023",
  ...
  },
  {
    ...
    description: "Contributed to machine learning projects and data analysis for predictive models.",
